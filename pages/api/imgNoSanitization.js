...
const localUploadDir = path.join(process.cwd(), 'public/uploads/img-unsanitized');
const xamppUploadDir = 'C:/xampp/htdocs/uploads/img-unsanitized';
...
const handler = async (req, res) => {
    upload.single('file')(req, res, async (err) => {
        ...
        fs.copyFile(localFilePath, xamppFilePath, (copyErr) => {
            ...
            res.status(200).json({ message: 'File uploaded successfully!', filePath: `/uploads/img-unsanitized/${req.file.filename}` });
        });
    });
};
